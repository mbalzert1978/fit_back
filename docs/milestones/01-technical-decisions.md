...
| Auth | JWT (Access/Refresh) über `pyjwt`, hinter der Naht `RegisterUserAccessTokens`; Passwort-Hashing Argon2id via `argon2-cffi`. Gewählt in [#95](https://github.com/mbalzert1978/fit_back/issues/95), siehe [2026-08-21-2230](../decisions/2026-08-21-2230-pyjwt-hinter-der-naht-refresh-token-als-hash.md). |
